...
class Sharing(CreateMixin):
    ...
    description = models.TextField("Descripción", max_length=2048, help_text='Número máximo de carácteres depende de la red social utilizada (IG: 2200, Twitter: 280).', null=True)
